...
const Vehicle = forwardRef((props, ref) => {
    ...
    const setVehicleAudioState = useGameStore((state) => state.setVehicleAudioState) // ✅ NEW
    ...
    // ✅ NEW: Initialize vehicle audio system
    ...
    // ✅ NEW: Register the audio state in the store
    useEffect(() => {
        if (audioInitialized) {
    ...
    }, [audioInitialized, isAudioEnabled, toggleAudio, setVehicleAudioState])
