...
const CameraControls = ({ followSpeed = 0.1, minGroundDistance = 0.5 }) => {
    ...
    const defaultCameraPosition = isPortrait ? [-2, 2.5, 7] : [-3, 2.5, 5]
    ...
    return (
        <>
            <OrbitControls
                ...
                enableDamping
                dampingFactor={0.025}
                minDistance={3} // Updated: Min zoom distance (prevents getting too close)
                maxDistance={6} // Updated: Max zoom distance (prevents getting too far)
